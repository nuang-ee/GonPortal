...
export default class Home extends Vue {
  ...
  usernameRules: Array<rule> = [this.requiredRule];
  passwordRules: Array<rule> = [this.requiredRule];
    ...
    if (this.user.username && this.user.password) {
      try {
        ...
        if (loginResult) {
          this.loading = false;
          this.dialog = false;
          alert(`Hello, ${loginResult.username}`);
          this.$router.push("/");
        }
      } catch (e) {
        this.loading = false;
        this.viewLoginStatus = true;
        this.resultMessage = "nvalid username or password";
      }
    }
  }
